...
/*        if(_currentAction == _moveVertical &&
        ...
        if(_currentActionType == EnemyActionType.MoveVertical)
        {
            ...
            Debug.Log("================ minXPosition " + (Math.Abs(_transform.position.x) - Math.Abs(_minXPosition.x)) + "   ================ minXPosition ");
            Debug.Log(Math.Abs(_transform.position.x) - Math.Abs(_minXPosition.x));
            Debug.Log("================");

           
            Debug.Log("================ _maxXPosition " + (Math.Abs(_transform.position.x) - Math.Abs(_maxXPosition.x)) + "   ================ _maxXPosition ");
            Debug.Log(Math.Abs(_transform.position.x) - Math.Abs(_maxXPosition.x));
            Debug.Log("================");
            ...
            if(Math.Abs(_transform.position.x) - Math.Abs(_minXPosition.x) < 0.02f)
            ...
            if (Math.Abs(_transform.position.x) - Math.Abs(_maxXPosition.x) < 0.02f)
