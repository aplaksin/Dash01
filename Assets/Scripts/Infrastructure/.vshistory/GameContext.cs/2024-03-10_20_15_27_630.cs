...
{ 
    ...
    private void TestGameStageInterpolation(int score)
    {
        ...
        gameStageStaticData.enemySpawnProbabilities = _interpolationStage.enemySpawnProbabilities;
        ...
        for (int i = 0; i < _interpolationStage.enemySpawnProbabilities.Length; i++)
        {
            Debug.Log("enemySpawnProbabilities - " + gameStageStaticData.enemySpawnProbabilities[i].ToString());
        }
