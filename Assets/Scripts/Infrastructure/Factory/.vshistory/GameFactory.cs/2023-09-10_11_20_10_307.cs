...
public class GameFactory : IGameFactory
{
    ...
    public void CreateGameGrid(LevelStaticData levelStaticData, Vector3 scaleVector)
    {
    ...
    public void SetPlayerPositionOnGrid(GameObject player, Vector3 spawnPoint)
    {
        player.transform.position = _cellPositionByCoords[spawnPoint];
    }
    ...
    public GameObject CreatePlayer(Vector2 spawnPoint, Vector3 scaleVector)
    {
        ...
        SetPlayerPositionOnGrid(player, spawnPoint);
