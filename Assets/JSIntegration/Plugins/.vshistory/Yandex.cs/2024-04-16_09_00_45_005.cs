...
public class Yandex : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        EventManager.OnGameLevelLoaded += Test;
    ...
    private void Test()
    {
        Debug.Log("Test Game.GameContext.CurrentTimeScale " + Game.GameContext.CurrentTimeScale);
    }
    ...
    private void GetPlayerBestScore(string score)
    {
        ...
        Debug.Log("GetPlayerBestScore bestScore " + bestScore);
    ...
    private void AdFullScreenClosed()
    {
        ...
        Debug.Log("AdFullScreenClosed Game.GameContext.CurrentTimeScale " + Game.GameContext.CurrentTimeScale);
