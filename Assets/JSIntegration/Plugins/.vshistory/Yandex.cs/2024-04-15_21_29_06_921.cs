...
public class Yandex : MonoBehaviour
{
    ...
    public static void SetIsPlayerAuthorised(string isAuthorised)
    {
    ...
    private static void GetPlayerBestScore(string score)
    {
        int bestScore = Int32.Parse(score);
        Game.GameContext.PlayerBestScore = bestScore;
